...
class Menu_InGame_CreateAVassal_ChangeGovernment
extends SliderMenu {
    protected Menu_InGame_CreateAVassal_ChangeGovernment() {
    ...
    protected Menu_InGame_CreateAVassal_ChangeGovernment(String civtag) {
        ArrayList<MenuElement> menuElements = new ArrayList<MenuElement>();
        int tempWidth = CFG.CIV_INFO_MENU_WIDTH * 2;
        int tY = 0;
        menuElements.add(new Button_Build(CFG.langManager.get("ChangeTypeOfGovernment"), Images.diplo_vassal, 0, 0, 2, tY, CFG.BUTTON_WIDTH * 2, false, false, 0, 0.0F){

            @Override
            protected int getWidth() {
                return Menu_InGame_CreateAVassal_ChangeGovernment.this.getElementW() * 2;
            }
        });
        tY += ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight();
        ...
        for (int i = 0; i < CFG.ideologiesManager.getIdeologiesSize(); ++i) {
            ...
            menuElements.add(new Button_Diplomacy_ChangeGovernment(j++, CFG.createVassal_Data.sCivTag, i, 2, tY, CFG.BUTTON_WIDTH * 2){
            ...
            tY += ((MenuElement)menuElements.get(menuElements.size() - 1)).getHeight();
            ((MenuElement)menuElements.get(menuElements.size() - 1)).setCheckboxState(CFG.ideologiesManager.getIdeologyID(CFG.createVassal_Data.sCivTag) == i);
        }
        menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Cancel"), -1, 2 + CFG.PADDING, tY += CFG.PADDING, CFG.BUTTON_WIDTH, true){
            ...
            @Override
            protected int getWidth() {
                return Menu_InGame_CreateAVassal_ChangeGovernment.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
            }
        });
        menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Confirm"), -1, 2, tY, CFG.BUTTON_WIDTH, true){ //make not clickable if trial for civil war
            ...
            protected int getPosX() {
                return Menu_InGame_CreateAVassal_ChangeGovernment.this.getElementW() + CFG.PADDING / 2;
            }
        ...
        this.initMenu(new SliderMenuTitle(CFG.langManager.get("Government"), CFG.BUTTON_HEIGHT * 3 / 5, true, true){
            ...
            protected void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
                ...
                oSB.setColor(new Color(CFG.createVassal_Data.oColor.r / 255.0f, CFG.createVassal_Data.oColor.g / 255.0f, CFG.createVassal_Data.oColor.b / 255.0f, 0.165f));
                ...
                oSB.setColor(new Color(CFG.createVassal_Data.oColor.r / 255.0f, CFG.createVassal_Data.oColor.g / 255.0f, CFG.createVassal_Data.oColor.b / 255.0f, 0.375f));
                ...
                CFG.createVassal_Data.getFlagOfCiv().draw(oSB, Menu_InGame_CreateAVassal_ChangeGovernment.this.getPosX() + CFG.PADDING * 2 + iTranslateX, Menu_InGame_CreateAVassal_ChangeGovernment.this.getPosY() - this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2 - CFG.createVassal_Data.getFlagOfCiv().getHeight(), CFG.CIV_FLAG_WIDTH, CFG.CIV_FLAG_HEIGHT);
                ImageManager.getImage(Images.flag_rect).draw(oSB, Menu_InGame_CreateAVassal_ChangeGovernment.this.getPosX() + CFG.PADDING * 2 + iTranslateX, Menu_InGame_CreateAVassal_ChangeGovernment.this.getPosY() - this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2);
                CFG.fontMain.getData().setScale(0.8f);
    ...
    protected final void actionElement(int iID) {
        if (iID == this.getMenuElementsSize() - 1) {
            ...
            if (toIdeology >= 0) {
                CFG.createVassal_Data.sCivTag = CFG.ideologiesManager.getRealTag(CFG.createVassal_Data.sCivTag) + CFG.ideologiesManager.getIdeology(toIdeology).getExtraTag();

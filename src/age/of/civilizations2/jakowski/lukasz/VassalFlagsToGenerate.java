...
class VassalFlagsToGenerate extends UnionFlagsToGenerate {
   protected int lordID = -1;
   ...
   protected boolean generateFlag(SpriteBatch oSB) {
      try {
         ...
         if (this.typeOfAction == UnionFlagsToGenerate_TypesOfAction.CIV_ID_SMALL) {
            ...
            CFG.flagManager.drawLordFlag(oSB, 27, 18, lordID);
            ...
            CFG.flagManager.drawLordFlag(oSB, 68, 44, lordID);
